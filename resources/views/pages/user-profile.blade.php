...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Pengaturan Profil'])
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">
                            {{ $user->role === 'admin' ? 'Administrator' : ($user->role === 'kec' ? 'Admin Kecamatan' : ($user->role === 'des' ? 'Admin Desa' : '')) }}
                        </p>
                    </div>
                </div>
                ...
                <div class="card">
                    <form role="form" method="POST" action={{ route('profile.update') }} enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-uppercase text-sm">Kontak Informasi</p>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                ...
                <div class="card card-profile">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <div class="h6 mt-4">
                                <i class="fa fa-envelope-open" aria-hidden="true"> </i> {{ $user->email}}
                            </div>
                            <div class="h6 font-weight-300">
                                <i class="fa fa-map-marker" aria-hidden="true"> </i> {{ $user->address}}
                            </div>
                        </div>
                    </div>
                </div>
