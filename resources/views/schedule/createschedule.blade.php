                    ...
                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="opd_id" class="form-control selectOpd">
                                    ...
                                    @foreach ($skpds as $skpd)
                                        <option value="{{ $skpd->id }}" @if ($userRole === 'skpd' && $skpd->id == auth()->user()->opd_id) selected @endif>
                                            {{ $skpd->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="name" name="name" class="form-control" placeholder="Nama Klien" aria-div="Email" >
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="phone" name="phone" class="form-control" placeholder="No Telpon Klien" aria-div="phone" >
                    ...
                    <div class="text-bold py-3">Informasi Konsultan</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" name="date" class="form-control datepicker" placeholder="Tanggal Konsultasi" data-date-format="dd-mm-yyyy" aria-label="Name"  >
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="place" name="place" class="form-control" placeholder="Masukan Tempat Konsultasi" aria-div="place" >
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="about" name="about" class="form-control" placeholder="Masukan Perihal Konsultasi" aria-div="about" >
